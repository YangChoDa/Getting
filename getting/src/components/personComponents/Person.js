...
class Person extends Component {
  ...
  constructor(props){
    ...
    if(props.match.params.username==='bishong'){
      this.state = {
        profile:{
          url:'../images/bishong1.png',
          name:'설탕',
          thick:'비숑',
          age:'4살',
          gender:'남'
    ...
    }else if(props.match.params.username==='children'){
      this.state = {
        profile:{
    ...
    return (
      <PageTemplate>
        <div className="personPage">
          <Tabs>
            <TabList>
              <Tab>{this.state.profile.name}</Tab>
            </TabList>
            <TabPanel>
              <div className="patInfo">
                <Profile profileInfo={this.state.profile} likes={this.state.likes} />
